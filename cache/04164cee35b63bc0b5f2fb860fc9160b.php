    ...
    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
        <?php $__currentLoopData = $hostels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hostel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white rounded-lg shadow hover:shadow-lg transition p-4">
                <img src="<?php echo e($hostel->image_url ?? 'assets/images/placeholder.jpg'); ?>" alt="<?php echo e($hostel->name); ?>"
                     class="w-full h-48 object-cover rounded-md mb-3">
                <h3 class="text-xl font-bold mb-1"><?php echo e($hostel->name); ?></h3>
                <p class="text-sm text-gray-600"><?php echo e($hostel->location); ?></p>
                <div class="flex items-center space-x-2 my-2 text-gray-700 text-sm">
                    <!-- Example icons can be replaced with actual icons -->
                    <span><?php echo e($hostel->bedrooms); ?> Beds</span>
                    <span><?php echo e($hostel->bathrooms); ?> Baths</span>
                </div>
                <p class="text-gray-800 font-semibold mb-3">
                    From ₨<?php echo e(number_format($hostel->price, 0)); ?>/week
                </p>
                <a href="hostel.php?id=<?php echo e($hostel->id); ?>" 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ashterhaider/Downloads/build/hostel-booking-demo/templates/index.blade.php ENDPATH**/ ?>